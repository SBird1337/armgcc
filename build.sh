...
../../src/gcc-2.95.1/configure --target=arm-elf --prefix=/arm-elf --disable-werror --with-cpu=arm7tdmi --with-no-thumb-interwork --with-mode=thumb --disable-multilib --enable-languages="c" --host=i686-pc-linux --build=i686-pc-linux
make all-gcc
make install-gcc
make all
make install