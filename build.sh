...
../../src/newlib-1.13.0/configure --target=arm-elf --prefix=$current_dir/arm-elf --disable-werror --with-no-thumb-interwork --with-cpu=arm7tdmi --disable-newlib-supplied-syscalls --disable-multilib --host=i686-pc-linux --build=i686-pc-linux
make MAKEINFO=true all
make MAKEINFO=true install